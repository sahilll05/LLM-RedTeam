...
VAJRA, a scoring architecture grounding detection in canary-token
exfiltration proofs, sandboxed exploit execution, and a
decomposed knowledge-vs-action rubric, validated against a
published consensus-labeled ground
truth~\cite{young2026executableweapons}, reducing false
...
% [TODO: Phase 2 — Dockerized Flask SQLi target]
